...
public class MasterLocalService {
	...
	public static class Client extends org.apache.thrift.TServiceClient
		...
		public void send_execute(String command)
				throws org.apache.thrift.TException {
	...
	public static class AsyncClient extends
		...
		public void execute(String command,
				...
				throws org.apache.thrift.TException {
			checkReady();
			execute_call method_call = new execute_call(command, resultHandler,
	...
	public static class AsyncProcessor<I extends AsyncIface> extends
		...
		public static class execute<I extends AsyncIface> extends
				org.apache.thrift.AsyncProcessFunction<I, execute_args, String> {
			public execute() {
				super("execute");
			}
	...
	public static class execute_args implements
		...
		private static final org.apache.thrift.protocol.TField COMMAND_FIELD_DESC = new org.apache.thrift.protocol.TField(
				"command", org.apache.thrift.protocol.TType.STRING, (short) 1);

		private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
		static {
			schemes.put(StandardScheme.class,
					new execute_argsStandardSchemeFactory());
		...
		static {
			Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(
					_Fields.class);
			tmpMap.put(_Fields.COMMAND,
					new org.apache.thrift.meta_data.FieldMetaData("command",
		...
		public execute_args(String command) {
			this();
			this.command = command;
		}
		...
		public int compareTo(execute_args other) {
			...
			lastComparison = Boolean.valueOf(isSetCommand()).compareTo(
					other.isSetCommand());
			if (lastComparison != 0) {
	...
	public static class execute_result implements
		...
		static {
			...
			schemes.put(TupleScheme.class,
					new execute_resultTupleSchemeFactory());
		}
		...
		public execute_result(String success) {
			this();
